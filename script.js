...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const animateOnScroll = () => {
    const elements = document.querySelectorAll('.product-card, .testimonial-card, .feature-card, .brand-logo, .contact-info-item, .timeline-item, .team-card, .faq-item, .review-card');
  ...
  const products = [
    { id: "brake-kit", name: "High-Performance Brake Kit", category: "Braking System", price: 299.99, image: "assets/product-1.jpg" },
    { id: "led-headlight", name: "Advanced LED Headlight Set", category: "Lighting", price: 189.99, image: "assets/product-2.jpg" },
    { id: "air-intake", name: "Carbon Fiber Air Intake System", category: "Engine", price: 249.99, image: "assets/product-3.jpg" },
    { id: "coilover-kit", name: "Adjustable Coilover Suspension Kit", category: "Suspension", price: 799.99, image: "assets/product-4.jpg" },
    { id: "exhaust-system", name: "Performance Exhaust System", category: "Engine", price: 459.99, image: "assets/product-1.jpg" },
    { id: "brake-pads", name: "Sport Brake Pads", category: "Braking System", price: 89.99, image: "assets/product-2.jpg" },
    { id: "cold-air-intake", name: "Cold Air Intake Kit", category: "Engine", price: 129.99, image: "assets/product-3.jpg" },
    { id: "fog-lights", name: "LED Fog Light Kit", category: "Lighting", price: 149.99, image: "assets/product-4.jpg" },
    { id: "steering-wheel", name: "Racing Steering Wheel", category: "Interior", price: 199.99, image: "assets/product-1.jpg" },
    { id: "clutch-kit", name: "Performance Clutch Kit", category: "Transmission", price: 349.99, image: "assets/product-2.jpg" },
    { id: "lowering-springs", name: "Lowering Springs", category: "Suspension", price: 219.99, image: "assets/product-3.jpg" },
    { id: "strut-brace", name: "Strut Tower Brace", category: "Suspension", price: 129.99, image: "assets/product-4.jpg" }
  ];
  
  // Sample review data
  const reviews = [
    { id: 1, name: "Michael S.", rating: 5, date: "2023-10-15", product: "High-Performance Brake Kit", comment: "These brakes are amazing! Stopping power is incredible and installation was straightforward." },
    { id: 2, name: "Sarah L.", rating: 4, date: "2023-09-22", product: "Advanced LED Headlight Set", comment: "Great visibility at night. The only reason I'm not giving 5 stars is because installation was a bit tricky." },
    { id: 3, name: "David W.", rating: 5, date: "2023-11-05", product: "Carbon Fiber Air Intake System", comment: "Noticeable power increase and the sound is awesome! Highly recommend." },
    { id: 4, name: "Jessica T.", rating: 5, date: "2023-10-30", product: "Adjustable Coilover Suspension Kit", comment: "Perfect stance and handling is significantly improved. Worth every penny!" },
    { id: 5, name: "Robert K.", rating: 4, date: "2023-11-12", product: "Performance Exhaust System", comment: "Great sound and performance gains. Installation took longer than expected." },
    { id: 6, name: "Emily H.", rating: 5, date: "2023-09-18", product: "Sport Brake Pads", comment: "Much better stopping power than OEM. No squeaking or dust issues." },
    { id: 7, name: "James B.", rating: 5, date: "2023-10-25", product: "Cold Air Intake Kit", comment: "Easy to install and the performance difference is noticeable. Great product!" },
    { id: 8, name: "Amanda C.", rating: 4, date: "2023-11-08", product: "LED Fog Light Kit", comment: "These lights are super bright and look great. Installation was a bit challenging." }
  ];
  ...
  let cart = JSON.parse(localStorage.getItem('gt86partz-cart')) || [];
